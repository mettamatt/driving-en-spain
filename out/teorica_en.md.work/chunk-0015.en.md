...
- On motorways and dual carriageways the minimum speed
allowed is 60 kilometres per hour.

- On the rest of the roads the minimum speed allowed
depends on each vehicle.
For example, on a road
where the maximum speed allowed
for a car is 90 kilometres per hour,
the minimum speed allowed will be
...
other vehicles.
For example, vehicles that accompany cyclists
in a competition.
SPECIAL
CYCLIST
<!-- Page: 259 -->
...
This effect is called tunnel vision
because you only see what is in front of you,
as if you were going through a tunnel.
0 km/h
65 km/h
130 km/h
180o
...
A person’s normal reaction time
...
Reaction distance
Braking distance
Space the vehicle travels from when you press
the brake until it stops completely.
This distance can change
...
- The load.
A vehicle with a heavy load takes longer to stop.

- Technical condition of the vehicle.
Condition of its brakes and other parts of the vehicle,
such as the tyres.
...
between two vehicles that pass each other
...
<!-- Page: 266 -->
Vehicles that can carry more than 3,500 kilos
and combinations of vehicles that measure
more than 10 metres must follow these rules
and also leave a minimum separation of 50 metres
...
Safety rule R.S.M.
What is it?
The set of rules and steps you must follow
when you do any manoeuvre with the vehicle:
Rear-view mirror
1
Signal
2
