...
For these lights to switch on
your vehicle has to be travelling at a speed higher
than 45 kilometres per hour
and it must not detect another vehicle nearby.
These lights switch off when they detect
...
and, in this way, the engine is what holds back the vehicle.
...
Device that prevents the wheels
...
of your motorcycle to lock
when you are carrying a passenger with you.
Autonomous emergency braking (AEB)
System that calculates, through a radar,
the distance there is and should be between your vehicle
and the one in front of you.
If there is very little distance between the vehicles,
this braking system will warn you
by means of a voice and a sound.
If you do not pay attention to these signals
and there is a risk of an accident
the system will perform emergency braking.
Watch video
Radar. System that can detect where an object is,
for example another car, and at what speed it is travelling.
<!-- Page: 95 -->
Emergency braking warning (EBD)
System that warns the driver of a vehicle
that the vehicle in front has to make
an emergency stop.
When the driver in front presses the brake
firmly and quickly, the brake lights
of their vehicle flash.
In this way, the system warns the driver behind
so that they have more time to brake
and try not to crash into it.
How are brakes used?
...
<!-- Page: 96 -->
To brake in an emergency in a vehicle without ABS,
...
To brake in an emergency in a vehicle with ABS,
you must press the brake pedal hard and fully
...
Tyres
Tyre failures
are a common cause of traffic accidents.
...
Watch video
Inflation pressure
Tyres are inflated with air
so that they are more resistant and better support the load
and the weight of the vehicle.
The manufacturer of each vehicle is the one who sets
how much air the tyres must have.
This amount of air will be the inflation pressure.
<!-- Page: 100 -->
...
- Problems with the brakes or with other elements
...
- Reduce speed slowly
until you stop the vehicle.
Do not stop abruptly.

- Immobilise the vehicle in a safe place.
...
and there are vehicles that carry a wheel
that only serves to get you
to the nearest garage.
It is called a space-saver wheel.
You can travel about 200 kilometres with this wheel
at a maximum speed of 80 kilometres per hour.
Watch video
<!-- Page: 103 -->
Wheel balancing
Wheel balancing consists of adding weight
...
if a wheel is turning faster than the others
and brakes it so that it does not skid.
This system helps to maintain the stability
of the vehicle on bends,
when going up a slope or when it is raining.
Electronic stability control
Safety system that helps the vehicle
to follow the path set by the steering wheel
and not to deviate when it does not turn
as much as the driver asks or turns too much.
This system helps you keep control
of the vehicle in dangerous situations.
For example, when swerving to avoid an obstacle
...
Cruise control
System that helps you maintain the speed
that you choose to drive without needing
to press the pedals to accelerate or slow down.
For example, travelling all the time
...
In the event of an accident, the chassis and the bodywork
deform and protect the vehicle so that
the passengers inside suffer less damage.
Rigid passenger compartment
Deformable parts
The seat belt
What is it for?
To protect all the people
travelling in a vehicle in the event of a sudden impact
...
means that a person has twice the chance
of surviving an accident.
In fact, there are fewer deaths from traffic accidents
since the seat belt exists.
For a seat belt to be useful
and safe it must meet the quality requirements
and be properly secured to the vehicle bodywork.
...
All the people travelling in a vehicle
